...
{
	String nombre_corto = "SPasswordField";
	...
	public SPasswordField(FuncionBase v)
	{
		bloqueado = false;
		dragged = false;
		funcion_base = v;
	...
	private void formFocusGained(FocusEvent fe)
	{
		funcion_base.solicitarBloqueo(this, true);
	}

	@SuppressWarnings("deprecation")
	private void formFocusLost(FocusEvent fe)
	{
		funcion_base.solicitarBloqueo(this, false);
		funcion_base.sendValueWidget(this, this.getText());
	}
	...
	private void formMouseMoved(java.awt.event.MouseEvent evt)
	{
		if (funcion_base.widget_actual.getClass().getName()
				.equals("SwingWidget.SPasswordField"))
		{
			int x = evt.getX();
			int y = evt.getY();
