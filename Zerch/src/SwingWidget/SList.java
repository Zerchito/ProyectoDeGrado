...
public class SList extends JList implements java.io.Serializable, Bloqueable
{
	private boolean bloqueado;
	private boolean dragged;
	private Color colorDesbloqueo;
	String nombre_corto = "SList";
	...
	{
		vector_argumentos = v;
		this.setListData(vector_argumentos);
	}
