...
public class Plantilla extends JPanel implements java.io.Serializable
{
	String nombre_corto = "Plantilla";
	...
	public Plantilla(FuncionBase v)
	{
		funcion_base = v;
