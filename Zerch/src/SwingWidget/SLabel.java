...
public class SLabel extends JLabel implements java.io.Serializable, Bloqueable
{
	String nombre_corto = "SLabel";
	FuncionBase funcion_base;
	Color fondo;
	Color fuente;
	private int posicion_ranura;

	private boolean bloqueado;
	private boolean dimensionar;
	private boolean mover;
	private boolean dragged;
	private Color colorDesbloqueo;
	Cursor puntero;

	public SLabel(FuncionBase v)
	{
		funcion_base = v;
		initFunctions();
		init();
	...
	private void init()
	{
		...
		setFont(new Font(
				"" + funcion_base.ventana_base.fuente_texto.combo_muestra
						.getSelectedItem(),
				funcion_base.ventana_base.fuente_texto.valor_negrita
						+ funcion_base.ventana_base.fuente_texto.valor_cursiva,
				funcion_base.ventana_base.fuente_texto.fuente_puntos));
		setEnabled(true);
	}
