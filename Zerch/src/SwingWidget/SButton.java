...
public class SButton extends JButton implements java.io.Serializable, Bloqueable
{
	String nombre_corto = "SButton";
	...
	private void formMousePressed(java.awt.event.MouseEvent evt)
	{
		...
		funcion_base.ventana_base.panel_eventos.textfield_destino
				.setEnabled(true);
		funcion_base.ventana_base.panel_eventos.label_textfield_origen
				.setText("" + posicion_ranura);
		funcion_base.ventana_base.panel_eventos.textfield_destino
				.setText("" + destino);
